...
import com.rndeep.fns_fantoo.repositories.DataStoreKey.Companion.PREF_KEY_LANGUAGE_CODE
import com.rndeep.fns_fantoo.repositories.DataStoreKey.Companion.PREF_KEY_REFRESH_ACCESS_TOKEN
import com.rndeep.fns_fantoo.repositories.DataStoreKey.Companion.PREF_KEY_SELECT_LANGUAGE_CODE
...
class TokenRefreshInterceptor @Inject constructor(private val dataStoreRepository: DataStoreRepository) :
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val appLangCode =
            runBlocking {
                if(dataStoreRepository.getString(PREF_KEY_SELECT_LANGUAGE_CODE)!=null){
                    dataStoreRepository.getString(PREF_KEY_SELECT_LANGUAGE_CODE)!!
                }else{
                    dataStoreRepository.getString(PREF_KEY_LANGUAGE_CODE)?:"en"
                }
            }
        val accessToken =
...
//        Timber.d("version : ${BuildConfig.VERSION_NAME} , os : ${Build.VERSION.RELEASE} , url : $refererUrl , country : $systemCountryCode")
        ...
        Timber.d("${ConstVariable.KEY_HEADER_LANG} => ${appLangCode}")
        Timber.d("${ConstVariable.Config.KEY_HEADER_REFERER} => ${refererUrl}")
