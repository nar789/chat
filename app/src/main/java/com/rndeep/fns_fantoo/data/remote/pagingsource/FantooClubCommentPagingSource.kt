...
class FantooClubCommentPagingSource @Inject constructor(
    @NetworkModule.ApiServer private val fantooClubService: FantooClubService,
    private val clubId: String,
    private val categoryCode: String,
    private val postId: String,
    private val integUid: String?
) : PagingSource<Int, FantooClubComment>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, FantooClubComment> {
        val page = params.key ?: STARTING_PAGE_INDEX
        return try {
            val pageId = if (page == STARTING_PAGE_INDEX) null else page.toString()
            val response = fantooClubService.fetchFantooClubComments(
                clubId,
                categoryCode,
                postId,
                integUid,
            ...
            val comments = response.replyList
    ...
    override fun getRefreshKey(state: PagingState<Int, FantooClubComment>): Int? {
