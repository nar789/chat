...
class DeleteAccountViewModel @Inject constructor(
    ...
    private var _isWithdrawal = MutableLiveData<Boolean>()
    val isWithdrawal: LiveData<Boolean> = _isWithdrawal
    ...
    fun startDeleteAccount() = viewModelScope.launch {
        val response = userInfoRepository.withdrawal(accessToken, IntegUid(integUid))
        Timber.d("responseData : $response")
        when (response) {
            is ResultWrapper.Success -> {
                clearUserInfo()
