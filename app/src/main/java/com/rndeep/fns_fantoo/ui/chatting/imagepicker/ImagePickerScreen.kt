...
fun PickerSelector(
    ...
    Row(
        ...
        Text(
            ...
            text = stringResource(R.string.c_cancel),
            fontSize = 14.sp,
            lineHeight = 20.sp,
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.m_all_pictures),
                fontSize = 16.sp,
                lineHeight = 22.sp,
            ...
            Text(
                text = String.format(stringResource(R.string.j_selected_pictures), imageCount),
                fontSize = 12.sp,
                lineHeight = 18.sp,
                color = colorResource(R.color.gray_900),
                textAlign = TextAlign.Center
        ...
        Text(
            ...
            text = stringResource(R.string.a_done),
            fontSize = 14.sp,
            lineHeight = 20.sp,
