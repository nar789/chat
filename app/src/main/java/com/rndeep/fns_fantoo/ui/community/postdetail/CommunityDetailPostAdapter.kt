...
import com.rndeep.fns_fantoo.ui.community.postdetail.viewholder.CommunityPostDetailCommentVH
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
          return when(viewType){
              ...
              TYPE_POST_COMMENT->{
                  ...
                  CommunityPostDetailCommentVH(PostDetailCommentLayoutBinding.bind(view),commentClickListener,replyClickListener,postType,isLoginUser)
              }
              else -> {
                    ...
                    when(payload){
                        ...
                        ConstVariable.PAYLOAD_LIKE_CLICK->{
                            when(holder){
                                ...
                                is CommunityPostDetailCommentVH ->{
