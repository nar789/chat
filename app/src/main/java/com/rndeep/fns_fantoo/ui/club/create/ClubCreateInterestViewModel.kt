...
class ClubCreateInterestViewModel @Inject constructor(
    ...
    private val _categoryItemLiveData = MutableLiveData<List<ClubInterestItem>>()
    val categoryItemLiveData :LiveData<List<ClubInterestItem>> get() = _categoryItemLiveData
