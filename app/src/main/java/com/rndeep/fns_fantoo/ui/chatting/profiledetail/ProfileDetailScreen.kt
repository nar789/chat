    ...
    Surface(
        ...
        Column {
            ...
            Row(
                ...
                val followBtnName =
                    stringResource(if (userFollowed) R.string.p_following else R.string.p_follow)
                IconSelector(
                    modifier = Modifier,
                ...
                val blockBtnName =
                    stringResource(if (userBlocked) R.string.c_release_account_block else R.string.c_do_block)
                IconSelector(
                    modifier = Modifier,
