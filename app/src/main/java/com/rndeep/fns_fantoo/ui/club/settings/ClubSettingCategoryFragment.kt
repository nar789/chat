...
class ClubSettingCategoryFragment :
    ...
    override fun initUi() {
        ...
        clubCategoryViewModel._currentCategoryCode.value = clubAllInfo?.interestCategoryId
        ...
        clubAllInfo?.interestCategoryId?.let {
            try {
                clubCategoryAdapter.setSelectedInterestCategoryId(it.toInt())
            }catch (e:Exception){
    ...
    override fun initUiActionEvent() {
        ...
        binding.commonTopbar.setTailTextClickListener {
            ...
            clubCategoryViewModel.saveCategory(
                clubId,
                hashMapOf(
                    ConstVariable.ClubDef.KEY_CLUB_INFO_INTEREST_CATEGORY_ID to (binding.rcCategory.adapter as ClubCategoryAdapter).getSelectedInterestCategoryId(),
                    KEY_UID to uid
                )
            )
        }
