...
class LoginFragment : BaseFragment<FragmentLoginBinding>(FragmentLoginBinding::inflate) {
                ...
                (object : AppLanguageBottomSheet.ItemClickListener {
                    override fun onItemClick(item: Language) {
                        lifecycleScope.launch {
                            ...
                            lifecycleScope.launch {
                                delay(200)
                                findNavController().navigate(R.id.loginFragment, arguments, NavOptions.Builder().setPopUpTo(R.id.loginFragment, true).build())
                            }
                            //액티비티 재시작방식
    ...
    private fun initSocialLoginButtons() {
        try {
            binding.tvMainSocial.text = getString(R.string.google) + getString(R.string.r_continue_at)
    ...
    fun simpleLoginImp(
        ...
        loginViewModel.socialId = snsId //+ "12345731"
