...
import com.rndeep.fns_fantoo.data.remote.model.community.BoardPostDetailHashTag
...
class CommunityPostDetailVH constructor(
    ...
    private val fullScreenListener: PostDetailImageAdapter.OnFullScreenClickListener?,
    ...
    fun communityPostBind(postItem : BoardPostDetailData,attachList :List<DetailAttachList>?,hashTagList : List<BoardPostDetailHashTag>?,ogTagList : List<Any>?){
        ...
        if(postItem.userBlockYn ==true || postItem.pieceBlockYn==true){
            ...
            setContentItem(postItem,attachList, hashTagList)
        }
    ...
    fun setContentItem(postItem: BoardPostDetailData, attachList: List<DetailAttachList>?, hashTagList: List<BoardPostDetailHashTag>?){
