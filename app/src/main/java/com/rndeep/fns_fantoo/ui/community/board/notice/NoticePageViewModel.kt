...
class NoticePageViewModel @Inject constructor(
    ...
    private var noticeSize = 10
    var noticeNextId: Int = 0
    ...
    fun getBoardNoticeItem(boardId: String?) {
        viewModelScope.launch {
            ...
            if(noticeNextId==0) commonNoticeItems= listOf()
            _loadingStateLiveData.value=true
            noticeSize=if((_commonNoticeLiveData.value?.size ?: 0) < 10) 10 else _commonNoticeLiveData.value!!.size
