...
class HomeViewModel @Inject constructor(
    ...
    //====================HOMETAB========================
    //Home 카테고리 전체 리스트 Db
    val homeItemLiveData= SingleLiveEvent<List<BoardPagePosts>>()
    ...
    fun getInitHomeData(context:Context){
        viewModelScope.launch {
            ...
            //추천
            homeRecommendClubLiveData.value=homeRepository.getRecommendClub(ConstVariable.DB_HOMECATEGORY)
    ...
    fun isNotUserData(){
        viewModelScope.launch {
            //home 의 bannerData call
            bannerItemLiveData.value=homeRepository.getBannerItem()
            homeItemLiveData.value=homeRepository.getIsNotUserData()
        }
    }
