...
class CategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentCategoryBinding.inflate(inflater, container, false).apply {
            ...
            categoryAdapter = CategoryAdapter { category ->
                ...
                viewModel.fetchFantooClubPosts(viewModel.getClubId(), category.categoryCode)
            }
            categoryList.run {
                adapter = categoryAdapter
                setHasFixedSize(true)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.selectedPosts.observe(viewLifecycleOwner) { list ->
            Timber.d("Selected Contents list: $list")
            contentsAdapter.submitList(list.toList())
        }
    }
