...
class LoginViewModel @Inject constructor(
    ...
    fun setLoadingStatus(isLoading:Boolean){
        loadingStatusLiveData.value = isLoading
    }

    private var _authCodeLiveData = SingleLiveEvent<AuthCodeResponse?>()
    val authCodeLiveData: SingleLiveEvent<AuthCodeResponse?>
