...
class MyWritePostAdapter : ListAdapter<BoardPagePosts,RecyclerView.ViewHolder>(diff) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            TYPECOMMUNITY -> {
                ...
                PostCommunityVH(CategoryHomePostBinding.bind(view), optionsClickListener,ConstVariable.POST_TYPE_LIST,ConstVariable.VIEW_COMMUNITY_MY,)
            }
            TYPENOLIST -> {
                val view =LayoutInflater.from(parent.context)
