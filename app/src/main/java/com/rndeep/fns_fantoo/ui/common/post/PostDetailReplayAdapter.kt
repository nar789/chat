...
class PostDetailReplayAdapter(
    ...
    private var isLikeShow : Boolean? =null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CommentReplyVH {
        ...
        return CommentReplyVH(PostDetailReplyLayoutBinding.bind(view),isLikeShow,listener)
    }
    ...
    fun setLikeShow(isShow :Boolean){
        this.isLikeShow=isShow
    }
}