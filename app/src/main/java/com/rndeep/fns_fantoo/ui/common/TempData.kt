...
object TempData {
    ...
    val tempRecommendClubList = listOf(
        RecommendationClub(1,"testClub",true, false,"ㅇㅇㅇ","ㅇㅇㅇ", 1,0,arrayListOf("태그1","태그2","태그3"),0),
        RecommendationClub(2,"testClub2",true,false,"ㅇㅇㅇ","ㅇㅇㅇ", 1,0,arrayListOf("태그1","태그2","태그3"),0),
        RecommendationClub(3,"testClub3",true,false,"ㅇㅇㅇ","ㅇㅇㅇ", 1,0,arrayListOf("태그1","태그2","태그3"),0),
        RecommendationClub(4,"testClub4",true,false,"ㅇㅇㅇ","ㅇㅇㅇ", 1,0,arrayListOf("태그1","태그2","태그3"),0),
        RecommendationClub(5,"testClub5",true,false,"ㅇㅇㅇ","ㅇㅇㅇ", 1,0,arrayListOf("태그1","태그2","태그3"),0),
        RecommendationClub(6,"testClub6",true,false,"ㅇㅇㅇ","ㅇㅇㅇ", 1,0,arrayListOf("태그1","태그2","태그3"),0),
        RecommendationClub(7,"testClub7",true,false,"ㅇㅇㅇ","ㅇㅇㅇ", 1,0,arrayListOf("태그1","태그2","태그3"),0),
        )
