package com.rndeep.fns_fantoo.ui.club.settings.management.swipe
...
class SwipeHelperCallback(private val recyclerViewAdapter : ArchiveBoardAdapter) : ItemTouchHelper.Callback(){
    ...
    override fun getMovementFlags(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder): Int {
        ...
        // 스와이프 방향 : 왼쪽, 오른쪽 인식
        // 설정 안 하고 싶으면 0
        return makeMovementFlags(UP or DOWN, 0)//LEFT or RIGHT)
    }
    ...
    private fun getView(viewHolder: RecyclerView.ViewHolder) :
            View = viewHolder.itemView.findViewById(R.id.ivDrag)
