...
class ContentsViewModel @Inject constructor(
    ...
    private var contentsList = mutableListOf<Contents>()
...
//        MoreMenuItem(R.drawable.icon_outline_hide, listOf(R.string.a_block_post, R.string.a_see_post), false)
    ...
    fun fetchFantooClubHomePosts(clubId: String) = viewModelScope.launch {
        ...
        when (response) {
            is ResultWrapper.Success -> {
                _homePosts.value = response.data.postList
            }
