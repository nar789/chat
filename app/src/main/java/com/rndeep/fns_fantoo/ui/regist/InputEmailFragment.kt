...
class InputEmailFragment :
    ...
    override fun initUi() {
        ...
        inputEmailViewModel.emailVerifyCodeLiveData.observe(viewLifecycleOwner) {
            result ->
                if(result){
                    navController.navigate(R.id.inputVerifyCodeFragment, bundleOf(
        ...
        inputEmailViewModel.checkingJoinedUserLiveData.observe(viewLifecycleOwner) {
