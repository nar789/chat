...
class AgreeConfirmFragment :
    ...
    override fun initUi() {
        ...
        agreeConfirmViewModel.loadingStatusLiveData.observe(viewLifecycleOwner) {
...
*/
    ...
    private fun adjustScrollWarningTextLayout(){
        binding.tvWarning.postDelayed({//visibility 상태변경(gone->visible)된 후 location찾을수있도록 delay추가
