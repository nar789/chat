...
class LoginSplashFragment :
    ...
    override fun initUiActionEvent() {
        Timber.d("contry : ${requireContext().resources.configuration.locales.get(0).country}, lang : ${requireContext().resources.configuration.locales.get(0).language} ")
    }
        ...
        lifecycleScope.launch {
            ...
            if (moveToPermissionCheckScreen) {
                ...
                if (moveToLoginScreen) {
                    delay(SPLASH_SHOW_TIME)
                    moveToNextScreen(R.id.action_loginSplashFragment_to_loginFragment, false)
                }
            }
        }
    }
