...
class ClubTabFragment : BaseFragment<FragmentClubTabBinding>(FragmentClubTabBinding::inflate) {
    ...
    override fun initUi() {
        ...
        clubViewModel.getInitClubData(requireContext())
    }
...
//                )
        ...
        clubRcAdapter.setOnRecommendClubClickListener(object :
            ...
            override fun onClubClick(v: View, id: String, name: String) {
                try {
                    val action =
                        ClubTabFragmentDirections.actionClubTabFragmentToClubPageDetail(id)
                    findNavController().navigate(action)
                }catch (e: Exception){
            ...
            override fun onJoinClick(v: View, id: String, name: String) {
                //클럽 가입
                if(clubViewModel.isUser()){
                    val action =
                        ClubTabFragmentDirections.actionClubTabFragmentToClubJoinFragment(id)
                    findNavController().navigate(action)
                }else{
